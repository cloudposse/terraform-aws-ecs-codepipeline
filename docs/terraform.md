...
| <a name="input_deployment_provider"></a> [deployment\_provider](#input\_deployment\_provider) | Deploy stage provider value. Valid values: CodeDeployToECS or ECS. Defaults to ECS. | `string` | `"ECS"` | no |
