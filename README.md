...
File a GitHub [issue](https://github.com/cloudposse/terraform-aws-ecs-codepipeline/issues), send us an [email](mailto:hello@cloudposse.com) or reach out to us on [Gitter](https://gitter.im/cloudposse/).
...
If you are interested in being a contributor and want to get involved in developing `terraform-aws-ecs-codepipeline`, we would love to hear from you! Shoot us an [email](mailto:hello@cloudposse.com).
...
`terraform-aws-ecs-codepipeline` is maintained and funded by [Cloud Posse, LLC][website].
